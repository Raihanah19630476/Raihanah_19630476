 ...
 * @author Windows 8.1
 */
public class Lwisata extends javax.swing.JFrame {
    ...
    private void cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakActionPerformed
        ...
        new config().tampilLaporan("src/Laporan/Lap_wisata.jrxml","SELECT * FROM wisata");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lwisata.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
